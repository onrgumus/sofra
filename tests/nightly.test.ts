...
describe('runNightlyMatching', () => {
  it('matches every office and mails one invite per table', async () => {
    ...
    const outcomes = await runNightlyMatching({ store, transport, from });
  ...
  it('addresses each mail to a whole table', async () => {
    ...
    await runNightlyMatching({ store, transport, from });
  ...
  it('only seats people who are actually in the building', async () => {
    ...
    const [outcome] = await runNightlyMatching({ store, transport, from });
  ...
  it('plans a specific day when asked, which is how it is tested at all', async () => {
    ...
    const outcomes = await runNightlyMatching({ store, transport, from, date });
  ...
  it('running twice replaces the plan rather than doubling it', async () => {
    ...
    const [first] = await runNightlyMatching({ store, transport, from });
    const [second] = await runNightlyMatching({ store, transport, from });
